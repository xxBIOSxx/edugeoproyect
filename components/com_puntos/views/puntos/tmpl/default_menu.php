...
<div id="slide_menu" style="<?php echo puntosHelper::getSettings('hs_show_controllmenu', 1) ? '' : "display:none;"; ?>">
	...
	<div class="puntos-actions" id="puntos-menu-actions">
		<label><input type="checkbox" id="all-puntos" /><?php echo JText::_('COM_PUNTOS_SHOW_ALL_TABS'); ?></label>
	</div>
	...
	<div class="puntos-tab-content" id="search-tab-container" data-id="search">
		<div class="search-actions">
			<span class="active" data-id="search-directions"><?php echo JText::_('COM_PUNTOS_SEARCH_DIRECTIONS'); ?></span><span data-id="search-address"><?php echo JText::_('COM_puntoS_SEARCH_ADDRESS'); ?></span><span data-id="search-puntos"><?php echo JText::_('COM_puntoS_SEARCH_punto'); ?></span>
		</div>
		...
		<form id="search-puntos" class="form menu" action="">
			<input type="text" id="search-puntos-input" title="<?php echo JText::_('COM_PUNTOS_WHAT_ARE_YOU_LOOKING_FOR');?>" class="required" />
			<button class="sexybutton right" type="submit">
				<span>
					<span><?php echo JText::_('COM_PUNTOS_SUBMIT'); ?></span>
				</span>
			...
			<div id="hms" class="puntos-more-spots">
			</div>
		</form>
	</div>
